...
def read_input_data() -> pd.DataFrame:
    while True:
        ...
        has_header = any(k in first_line for k in ["ticket id", "order no", "contact", "voucher"])
    ...
    while True:
        try:
            ...
            if choice == "r":
                ...
                print("\n🛑 Invalid input — please press ENTER or type 'R'.")
...
def main():
    ...
    while True:
        ...
        # Soert rows by the voucher amounts
        ...
        file_name = f"{user_session}_{safe_start}_to_{safe_end}.txt"
